...
public:
    ...
    void addBidirectionalCapacity(int u, int v, double cap1, double cap2)
    {
    ...
    double max_flow_edmond_karp(int s, int t)
    {
        double flow = 0;
        ...
        while(1)
        {
            ...
            double minimum_residual_capacity = inf ;
            ...
            double possible_new_flow = minimum_residual_capacity;
